...
export const DEFAULT_APPROVAL_STAGES = [
  {
    ...
    requiredRole: ['admin', 'manager', 'finance_manager'],
    sequence: 0,
  },
  {
    id: 'department',
    ...
    requiredRole: ['manager', 'department_head'],
    sequence: 1,
  },
  {
    id: 'finance',
    ...
    requiredRole: ['finance_manager', 'finance_analyst', 'admin'],
    sequence: 2,
  },
  {
    id: 'executive',
    ...
    requiredRole: ['director', 'ceo', 'cfo', 'admin'],
    sequence: 3,
  },
];

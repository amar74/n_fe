        ...
        <div className="flex justify-between items-end">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[#344054] text-sm font-normal font-inter leading-tight">Opportunities</span>
            </div>
            
            
            <h1 className="text-[#1A1A1A] text-3xl font-semibold font-inter leading-loose">Opportunities</h1>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center justify-center py-16 gap-4">
            ...
            <div className="flex flex-col items-center gap-2">
              <h3 className="text-[#1A1A1A] text-xl font-semibold font-inter">No opportunities yet</h3>

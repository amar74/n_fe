        ...
        <div className="flex justify-between items-end">
          ...
          <div className="flex items-start gap-3">
            ...
            >
              ...
              <span className="text-white text-sm font-semibold font-outfit leading-normal">Create Project</span>
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center justify-center py-16 gap-4">
            ...
            <div className="flex flex-col items-center gap-2">
              <h3 className="text-[#1A1A1A] text-xl font-semibold font-outfit">No projects yet</h3>
            ...
            <button className="mt-4 h-11 px-6 py-2 bg-gradient-to-r from-slate-800 to-slate-900 rounded-lg flex items-center gap-2 hover:from-slate-900 hover:to-black transition-all shadow-lg">
              <Plus className="w-5 h-5 text-white" />
              <span className="text-white text-sm font-semibold font-outfit">Create Your First Project</span>
            </button>
          </div>
        </div>
      </div>

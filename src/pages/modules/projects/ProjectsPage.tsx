      ...
      <div className="flex flex-col w-full p-6 gap-6">
        ...
        <div className="flex justify-between items-end">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[#344054] text-sm font-normal font-inter leading-tight">Projects</span>
            </div>
            
            
            <h1 className="text-[#1A1A1A] text-3xl font-semibold font-inter leading-loose">Projects</h1>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            >
              ...
              <span className="text-white text-sm font-semibold font-inter leading-normal">Create Project</span>
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            { label: 'In Progress', value: '0', icon: FolderKanban, color: 'text-yellow-600', bg: 'bg-yellow-50' },
            { label: 'Completed', value: '0', icon: FolderKanban, color: 'text-green-600', bg: 'bg-green-50' },
            { label: 'On Hold', value: '0', icon: FolderKanban, color: 'text-red-600', bg: 'bg-red-50' },
          ].map((stat, index) => (
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center justify-center py-16 gap-4">
            ...
            <div className="flex flex-col items-center gap-2">
              <h3 className="text-[#1A1A1A] text-xl font-semibold font-inter">No projects yet</h3>
              <p className="text-gray-500 text-sm font-inter text-center max-w-md">
                Organize and track your projects from start to finish. Manage timelines, deliverables, and team collaboration.
              </p>
            </div>
            <button className="mt-4 h-11 px-6 py-2 bg-gradient-to-r from-slate-800 to-slate-900 rounded-lg flex items-center gap-2 hover:from-slate-900 hover:to-black transition-all shadow-lg">
              <Plus className="w-5 h-5 text-white" />
              <span className="text-white text-sm font-semibold font-inter">Create Your First Project</span>
            </button>
          </div>
        </div>
      </div>

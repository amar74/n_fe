    ...
    <div className="w-full h-full bg-[#F5F3F2] font-inter">
      <div className="flex flex-col w-full p-6 gap-6">
        ...
        <div className="flex justify-between items-end">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[#344054] text-sm font-normal font-inter leading-tight">Contracts</span>
            </div>
            
            
            <h1 className="text-[#1A1A1A] text-3xl font-semibold font-inter leading-loose">Contracts</h1>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            >
              ...
              <span className="text-white text-sm font-semibold font-inter leading-normal">Create Contract</span>
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            { label: 'Total Contracts', value: '0', icon: FileSignature, color: 'text-blue-600', bg: 'bg-blue-50' },
            { label: 'Active', value: '0', icon: FileSignature, color: 'text-green-600', bg: 'bg-green-50' },
            { label: 'Pending', value: '0', icon: FileSignature, color: 'text-yellow-600', bg: 'bg-yellow-50' },
            { label: 'Expired', value: '0', icon: FileSignature, color: 'text-red-600', bg: 'bg-red-50' },
          ].map((stat, index) => (
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center justify-center py-16 gap-4">
            <div className="p-4 bg-slate-50 rounded-full">
              <FileSignature className="w-12 h-12 text-slate-600" />
            </div>
            <div className="flex flex-col items-center gap-2">
              <h3 className="text-[#1A1A1A] text-xl font-semibold font-inter">No contracts yet</h3>
              <p className="text-gray-500 text-sm font-inter text-center max-w-md">
                Create and manage contracts with your clients. Track status, renewals, and expiration dates.
              </p>
            </div>
            <button className="mt-4 h-11 px-6 py-2 bg-gradient-to-r from-slate-800 to-slate-900 rounded-lg flex items-center gap-2 hover:from-slate-900 hover:to-black transition-all shadow-lg">
              <Plus className="w-5 h-5 text-white" />
              <span className="text-white text-sm font-semibold font-inter">Create Your First Contract</span>
            </button>
          </div>
        </div>
      </div>

    ...
    <div className="w-full h-full bg-[#F5F3F2] font-outfit">
      <div className="flex flex-col w-full p-6 gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            { label: 'Total Proposals', value: '0', icon: FileText, color: 'text-blue-600', bg: 'bg-blue-50' },
            { label: 'Draft', value: '0', icon: FileText, color: 'text-gray-600', bg: 'bg-gray-50' },
            { label: 'Submitted', value: '0', icon: FileText, color: 'text-yellow-600', bg: 'bg-yellow-50' },
            { label: 'Approved', value: '0', icon: FileText, color: 'text-green-600', bg: 'bg-green-50' },
          ].map((stat, index) => (
